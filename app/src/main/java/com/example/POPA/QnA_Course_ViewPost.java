...
public class QnA_Course_ViewPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qna_course_view_post);
        ...
        Questions.getRef().child("CID" + id).child(key).addListenerForSingleValueEvent(usersLikedValueEventListener);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        username.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent = new Intent(QnA_Course_ViewPost.this, ViewProfile.class);
        ...
        Questions.getRef().child("CID" + id).child(key).addListenerForSingleValueEvent(questionValueEventListener);
        ...
        likeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (liked) {
                    ...
                    //decrease postCreator's credit count
                    ValueEventListener postCreatorValueEventListener = new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    //increase postCreator's credit count
                    ValueEventListener postCreatorValueEventListener = new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!answer.equals("")) {
                    ...
                    DatabaseReference ref = Questions.getRef().child("CID" + id).child(key).child("answers").push();
                    ...
                    likeButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Questions.getRef().child("CID" + id).child(key).child("answers").child(ref.getKey()).addListenerForSingleValueEvent(usersLikedValueEventListener);
    ...
    protected void loadComments() {
                ...
                for (DataSnapshot child : children) {
                    ...
                    likeButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Questions.getRef().child("CID" + id).child(key).child("answers").child(child.getKey()).addListenerForSingleValueEvent(usersLikedValueEventListener);
        ...
        Questions.getRef().child("CID" + id).child(key).child("answers").addListenerForSingleValueEvent(answersLikedValueEventListener);
    }
}